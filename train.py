...
def train_cnn_rnn():
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            # best_at_step =  400
            # checkpoint_prefix = 'checkpoints_1502365645/model'
            ...
            logging.critical('Accuracy on test set: {} test instance {}'.format(float(total_test_correct) / len(y_test), cnt))

    path = checkpoint_prefix + '-' + str(best_at_step)
    # print (path)
    os.rename(checkpoint_dir, trained_dir)
